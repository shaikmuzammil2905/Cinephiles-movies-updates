      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6">
        ...
        {activeTrailers.length === 0 ? (
          <div className="bg-white rounded-xl border border-slate-200 p-8 text-center space-y-2 shadow-xs">
            ...
            <h3 className="text-sm font-bold text-slate-800">No Trailers Available</h3>
            <p className="text-xs text-slate-500 max-w-xs mx-auto">
              Published movie trailers and teasers will appear here live.
            </p>
          </div>
        ) : (
