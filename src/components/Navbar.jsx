...
export function Navbar({ activeTab, setActiveTab }) {
  ...
  return (
    <nav className="bg-[#031738] border-t border-slate-800 text-white shadow-lg sticky top-20 z-40">
          ...
          {navItems.map((item) => {
            ...
            return (
              <button
                ...
                className={`flex items-center gap-2 px-4 py-3 text-xs sm:text-sm font-extrabold tracking-wide transition-all whitespace-nowrap border-b-2 ${
                  isActive
